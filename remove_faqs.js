...
const correctQuickLinks = `
                              ...
                              <div class="d-flex flex-column">
                                  <div class="quick-link-row" style="cursor: pointer;" onclick="window.location.href='support.html'">
                                  ...
                                  <div class="quick-link-row" style="cursor: pointer;" onclick="window.location.href='profile-settings.html'">
