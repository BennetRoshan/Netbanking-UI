...
// I will just replace the exact block that was lost
const targetLostBlock = `                    <div class="text-center mt-4 pagination-controls" id="paginationContainer">
                    </div>
                </div>
        </div>
...
const restoredBlock = `                    <div class="text-center mt-4 pagination-controls" id="paginationContainer">
                    </div>
                </div>
...
if (content.includes(targetLostBlock)) {
    content = content.replace(targetLostBlock, restoredBlock);
