...
if(fs.existsSync(loansFile)) {
    ...
    const newTabs = `<ul class="nav nav-tabs-custom mb-4 border-bottom border-secondary-subtle">
                      <li class="nav-item ps-3">
                          <a class="nav-link active" href="loans/loans.html">Overview</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="loans/loan-tracking.html">My Loans</a>
                      </li>
                      <li class="nav-item me-5">
                          <a class="nav-link" href="loans/new-loan.html">Apply for Loan</a>
                      </li>
                      <li class="nav-item ms-5 ps-5">
                          <a class="nav-link" href="loans/loan-eligibility.html">Loan Offers</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="loans/loans-emi.html">Emi Calculator</a>
                      </li>
                  </ul>`;
    ...
    const emiTabs = `<ul class="nav nav-tabs-custom mb-4 border-bottom border-secondary-subtle">
                      <li class="nav-item ps-3">
                          <a class="nav-link" href="loans/loans.html">Overview</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="loans/loan-tracking.html">My Loans</a>
                      </li>
                      ...
                      <li class="nav-item">
                          <a class="nav-link active" href="loans/loans-emi.html">Emi Calculator</a>
                      </li>
                  </ul>`;
