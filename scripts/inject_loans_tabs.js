...
const getTabs = (activeIndex) => `
                  ...
                  <ul class="nav nav-tabs-custom mb-4 border-bottom border-secondary-subtle">
                      <li class="nav-item ps-3">
                          <a class="nav-link ${activeIndex === 0 ? 'active' : ''}" href="loans/loans.html">Overview</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link ${activeIndex === 1 ? 'active' : ''}" href="loans/loan-tracking.html">My Loans</a>
                      </li>
                      <li class="nav-item me-5">
                          <a class="nav-link ${activeIndex === 2 ? 'active' : ''}" href="loans/new-loan.html">Apply for Loan</a>
                      </li>
                      <li class="nav-item ms-5 ps-5">
                          <a class="nav-link ${activeIndex === 3 ? 'active' : ''}" href="loans/loan-eligibility.html">Loan Offers</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link ${activeIndex === 4 ? 'active' : ''}" href="loans/loans-emi.html">Emi Calculator</a>
                      </li>
                  </ul>`;
