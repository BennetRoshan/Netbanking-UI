...
filesToUpdate.forEach(file => {
    ...
    if(fs.existsSync(filePath)) {
        ...
        content = content.replace('<a href="dashboard/statements.html" class="text-secondary small text-decoration-none">View All ></a>', 
                                  '<a href="transfers/manage-beneficiaries.html" class="text-secondary small text-decoration-none">View All ></a>');
