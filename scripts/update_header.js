...
const notificationNew = `<!-- Notification -->
                      <div class="position-relative dropdown" style="cursor: pointer;">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end shadow border-0 p-0 mt-3" style="width: 320px; border-radius: 12px; overflow: hidden;">
                              ...
                              <li>
                                  <a class="dropdown-item p-3 border-bottom text-wrap" href="info/kyc.html">
                                      <div class="d-flex align-items-center gap-3">
...
const userProfileNew = `<!-- User Profile -->\n                      <a href="dashboard/profile.html" class="d-flex align-items-center gap-3 border-start ps-4 text-decoration-none">`;
...
files.forEach(file => {
    ...
    if(content.includes('<!-- User Profile -->\n                      <div class="d-flex align-items-center gap-3 border-start ps-4">') || content.includes('<!-- User Profile -->\r\n                      <div class="d-flex align-items-center gap-3 border-start ps-4">')) {
        ...
        if(blockStartIdx !== -1) {
            ...
            if(matched) {
                let replacedBlock = matched[0].replace(/<div class="d-flex align-items-center gap-3 border-start ps-4">/, '<a href="dashboard/profile.html" class="d-flex align-items-center gap-3 border-start ps-4 text-decoration-none">');
