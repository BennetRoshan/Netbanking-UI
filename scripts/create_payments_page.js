        ...
        <div class="col-xl-4 d-flex flex-column gap-4">
            ...
            <div class="card border-0 rounded-4 shadow-sm p-4 bg-white">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="dashboard/statements.html" class="text-secondary small text-decoration-none">View All ></a>
                </div>
...
content = content.replace(/<a class="nav-link text-white active([^"]*)" href="transfers/fund-transfer.html" style="background-color: #007bff;">/, '<a class="nav-link text-white-50$1 sidebar-link" href="transfers/fund-transfer.html">');
content = content.replace(/<a class="nav-link text-white-50([^"]*)" href="javascript:void\(0\)" onclick="alert\('This section is coming soon!'\)">\s*<i class="bi bi-list-ul fs-5"><\/i> Payments\s*<\/a>/, '<a class="nav-link text-white active$1" href="transfers/payments.html" style="background-color: #007bff;">\n                    <i class="bi bi-list-ul fs-5"></i> Payments\n                </a>');
...
allFiles.forEach(file => {
    ...
    html = html.replace(/href="javascript:void\(0\)" onclick="alert\('This section is coming soon!'\)">\s*<i class="bi bi-list-ul fs-5"><\/i> Payments/g, 'href="transfers/payments.html">\n                      <i class="bi bi-list-ul fs-5"></i> Payments');
