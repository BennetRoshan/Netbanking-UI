...
topics.forEach(topic => {
    ...
    newContent = newContent.replace(/<span class="text-dark">Support<\/span>/, `<a href="support.html" class="text-decoration-none text-muted">Support</a> / <span class="text-dark">${topic.title}</span>`);
...
filesToUpdate.forEach(file => {
    ...
    topics.forEach(topic => {
        // e.g. onclick="window.location.href='account.html'" -> onclick="window.location.href='support-accounts.html'"
